...
export const YUANFANG_LAYOUT_GRAMMAR: Record<YuanfangLayoutGrammarKey, YuanfangLayoutGrammar> = {
  topHeroTitle: layout({ key: "topHeroTitle", label: "顶部强标题", families: ALL_FAMILIES, titlePlacement: "top or upper-center hero zone", visualSubjectPlacement: "middle/lower themed field", logoSafeZone: "top-right separated from title", titleSafeZone: "designed top band, not blank board", canvasSuitability: ["vertical", "horizontal"], forbiddenWhen: ["top area has high-detail subject", "logo conflicts with title"] }),
  leftTitleRightVisual: layout({ key: "leftTitleRightVisual", label: "左题右图", families: ["openClass", "enrollment", "literaryActivity", "achievementShowcase"], titlePlacement: "left third or left-center lockup", visualSubjectPlacement: "right and lower-right", logoSafeZone: "top-right above visual subject", titleSafeZone: "left low-complexity color/light structure", canvasSuitability: ["vertical", "horizontal"], forbiddenWhen: ["left side already crowded", "reading order becomes unclear"] }),
  ...
  centerHeroLockup: layout({ key: "centerHeroLockup", label: "中心主视觉标题组", families: ALL_FAMILIES, titlePlacement: "center or upper-center dominant lockup", visualSubjectPlacement: "surrounding, lower, side, or behind low-contrast field", logoSafeZone: "top-right clean patch", titleSafeZone: "center designed low-complexity structure", canvasSuitability: ["vertical"], forbiddenWhen: ["center becomes empty placeholder", "center has high-detail subject"] }),
  diagonalCampaignFlow: layout({ key: "diagonalCampaignFlow", label: "斜向活动动线", families: ["companyActivity", "brandEvent", "openClass", "enrollment"], titlePlacement: "along or against diagonal flow", visualSubjectPlacement: "opposite diagonal anchor", logoSafeZone: "top-right clear of diagonal streaks", titleSafeZone: "diagonal low-complexity lane", canvasSuitability: ["vertical", "horizontal"], forbiddenWhen: ["diagonal motion harms readability", "looks like stock sale banner"] }),
  ...
  frameContainer: layout({ key: "frameContainer", label: "主题框景 / 容器", families: ["literaryActivity", "guofengLiterature", "poetryFestival", "campusActivity", "brandEvent"], titlePlacement: "inside or attached to designed frame", visualSubjectPlacement: "around frame edges or secondary scene", logoSafeZone: "outside frame or top-right frame gap", titleSafeZone: "container has texture and depth", canvasSuitability: ["vertical"], forbiddenWhen: ["frame looks like blank board", "container implies generated text"] }),
};
